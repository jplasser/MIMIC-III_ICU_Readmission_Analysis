...
if args.mode == 'train':
    ...
    # Prepare training
    path = 'keras_states_mimic4/' + model.final_name + '.epoch{epoch}.test{val_loss}.state'
    ...
    path = os.path.join("test_predictions_mimic4", os.path.basename(args.load_state)) + "predictions.csv"
