...
# Read data
train_raw = utils.load_train_data(train_reader, discretizer, normalizer, diseases_embedding, demographic, small_part)
...
val_raw = utils.load_data(val_reader, discretizer, normalizer, diseases_embedding1, demographic1, small_part)
