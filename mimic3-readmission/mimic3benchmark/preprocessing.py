...
def assemble_episodic_data(stays, diagnoses):
    ...
    data = { 'Icustay': stays.ICUSTAY_ID, 'Age': stays.AGE, 'Length of Stay': stays.LOS,'Mortality': stays.MORTALITY0,'Transfer Back': stays.TRANSFERBACK, 'Die in Ward': stays.DIEINWARD, 'Readmit within 30 days': stays.LESS_TAHN_30DAYS, 'Die within 30 days': stays.DIE_LESS_TAHN_30DAYS ,'Readmission': stays.READMISSION }
